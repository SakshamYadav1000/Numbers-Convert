...
int main()
{
    ...
    //---------------------------------------------if thesystem is octal--------------------------------------------------//    
        else if(y==3)
        {
            int x;
            cout<<"    Enter Your Number In Octal System  [0-8]: ", cin>>x;
            cout<<"    Number In Decimal System.               : ";
            cout<<octatodeci(x);
            b=octatodeci(x);
            cout<<"\n    Number In Binary.                       : ";
    ...
    cout<<"\t\t\t\t\t\t\t    Enter your choice (Y/N):\t", cin>>choice;
